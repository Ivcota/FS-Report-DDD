...
import { PublisherRepository } from "@/module/service_report/infrastructure/repositories/publisher_repository";
...
export class ServiceReportModule {
  ...
  constructor(private prismaClient: PrismaClient, aiService: AIService) {
    ...
    this.publisherRepository = new PublisherRepository(this.prismaClient);
