...
import { SimplifiedServiceRecord } from "@/application/service_report/use_cases/parse_service_records/parse-service_records_dto";
...
function ServiceRecordParserHeader() {
  return (
    <>
...
const ServiceRecordParserError = ({ error }: { error: string }) => {
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          <ServiceRecordForm action={action} isLoading={isLoading} />
